    ...
    <div>
      ...
      <section id="about__history">
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              <img src="./images/popo.jpg" alt="" class="about__history_img" />
            </div>
            <div class="col-md-6">
              <div class="history__content">
                ...
                <p>
                  ...
                  enforcement agency in Nigeria. It has staff deployment across
                  the 36 states of the country and the Federal Capital Territory
                  (FCT). The command and control of the Nigeria Police Force is
                  under the Inspector-General of Police (IGP). For
                  administrative ease, the Force is divided into eight (8)
                  administrative departments, viz. Finance and Administration;
                  Operations; Logistics and Supply; Force Criminal Investigation
                  Department; Training and Development; Research and Planning;
                  Information and Communication Technology and Force
                  Intelligence Bureau, each headed by a Deputy Inspector-General
                  of Police (DIG). The Force is further divided into 17
                  Operational Zonal Commands (usually comprising between two and
                  three State Commands) and 37 State Commands including the FCT.
                  While the Zone is headed by an Assistant Inspector-General of
                  Police (AIG), the State Command is headed by a Commissioner of
                  Police (CP), the Area Command by an Assistant Commissioner of
                  Police (ACP) and the Division by an officer in the
          ...
          <div class="row">
            <div class="possap__content">
              ...
              <p>
                ...
                administration of all its fee-based Specialized Services through
                automation. This solution will use smart technology to automate
                and manage the entire process of rendering Police Specialized
                Services in an efficient, transparent and highly professional
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <p>
                    ...
                    administrative and operational activities through fusion of
        ...
        <div class="container">
          <div class="row">
            <div class="services__content">
              ...
              <p>
                With respect to extant and relevant laws, the Police Force Order
                which draws strength from the Police Act 2020, provides for the
                Nigeria Police to charge fees for specialized services rendered
                to the Nigerian public. These include the services of Police
                Orderlies for protection and safety of lives and properties.
                Likewise, the Police Act 2020 permits the NPF to charge fees for
                private engagements and other Specialized Services. It is on
                this basis that the Police has since its inception applied fees
                on services such as Escort Services, Issuance of Licenses for
                Arms & Ammunition, Police Extracts and other Specialized
                Services. Police Specialized Services also referred to as Police
                Revenue Services include Police Escort & Special Security
                Services, Arms & Ammunition Licenses, Contractor Registration,
                International Driving Permit, Police Extract & Information
                Services, other permits & reports services provided pursuant to
                the Force Order.
              </p>
              <div class="row">
                <div class="col-md-6">
