    ...
    // Dashboard Routes
    {
      ...
      children: [
        { path: '', element: <Navigate to="/dashboard/main" replace /> },
        {
            path: 'service',
            children: [
              { path: '', element: <Navigate to="/dashboard/service/police-extract" replace /> },
              { path: 'police-extract', element: <PoliceExtract /> },
              { path: 'character-clearance-certificate', element: <CharacterCertificate /> },
...
// Services
const PoliceExtract = Loadable(lazy(() => import('../pages/services/police-extract')));
const GuardEscort = Loadable(lazy(() => import('../pages/services/guard-escort')));
const CharacterCertificate = Loadable(lazy(() => import('../pages/services/character-certificate')));
